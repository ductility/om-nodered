...
class KinematicsPose(genpy.Message):
  _md5sum = "bad8d5def2efabb0336490f8e9f6f2e2"
...
float64 w
"""
  __slots__ = ['pose','max_accelerations_scaling_factor','max_velocity_scaling_factor','tolerance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pose,max_accelerations_scaling_factor,max_velocity_scaling_factor,tolerance
